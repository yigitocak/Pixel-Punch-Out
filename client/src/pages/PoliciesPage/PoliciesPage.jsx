    ...
    <section className="policies">
      <div className="policies__container">
        ...
        <span className="policies__info">
          ...
          Used for account verification, password recovery, and essential
          communications.
          <br />
        ...
        <span className="policies__info">
          ...
          information at any time. Deleting your account will permanently remove
          your personal information from our database. To manage or delete your
          account, please use the settings available within the game interface.
        </span>
