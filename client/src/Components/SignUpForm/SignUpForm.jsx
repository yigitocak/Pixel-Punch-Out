...
export const SignUpForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!/[A-Z]/.test(password) || !/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+/.test(password)) {
            return setError("Password must include at least one uppercase letter and one special character.");
        }
        if (!isChecked) {
        ...
        try {
            ...
            if(error.response.status === 409) setError("Username or email already exists.")
